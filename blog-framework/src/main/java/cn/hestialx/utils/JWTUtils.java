...
public class JWTUtils {
    ...
    //设置秘钥明文
    public static final String JWT_KEY = "0TZ29T3cN6Z/mbIyQCxHIYEafXWIGmScyETgBuxpCvY=";
...
//        String dd = JWTUtils.createJWT("1","dd",6666L);
//        System.out.println(dd);
//        Claims claims = JWTUtils.parseJWT(dd);
