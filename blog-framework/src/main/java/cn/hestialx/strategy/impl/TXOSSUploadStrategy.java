package cn.hestialx.strategy.impl;

import cn.hestialx.config.CosConfigProperties;
...
/**
 * @author lixu
 * @create 2023-02-28-15:44
 */
@Slf4j
@Component("TXOSSUploadStrategy")
public class TXOSSUploadStrategy extends AbstractUploadStrategyImpl {

    private final CosConfigProperties cosConfigProperties;

    public TXOSSUploadStrategy(CosConfigProperties cosConfigProperties) {
